...
public class PokemonArena {
  	...
  	public static void main(String[]args) {
    	...
    	if (firstTurn() == 1){ //If the trainer goes first
    		...
    		while (validGame()){ 
    			...
    			calculateDamage(); //Calculate the damage from the trainer's move
    			if (validGame() && bigEnemySkip==false){  //If the game is still valid and the enemy doesn't skip their turn
    				enemyMove(); //The enemy makes their move
    				calculateDamage(); //Calculate the damage frp, the enemy's move
    			}//end if
   ...
   public static void welcomeMessage(){
   		...
   		System.out.print("Hello Trainer! Welcome to the Pokemon Ga-ole! \n"+
   			...
   			"a MASSIVE lineup of enemy Pokemon. Will you become Best Trainer?\n"+
   			"Test Your Luck in Pokemon Ga-ole! Get the highest score! \n");
   ...
   public static void readFile(){
		String fileName = "/Volumes/T7/School/Software Engineering/Year 1/Sem 3/OOP (VScode)/AssignmentJava/Pokemon/src/pokemon.txt"; //This will read the "pokemon.txt" file
    	Scanner kb = new Scanner(System.in);
   ...
   public static void playerMove(){
   		...
   		while (true){
   			...
   			else if (choice > 0 && choice <=3){ //Check if the player's choice is a valid option (1,2 or 3)
   ...
   public static void enemyMove(){
   		...
   		else{ //Sse the initially selected attack from the random.
